  ...
  <body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top navbar-blue">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">TOKO MULIA PATI</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse"> 
          <ul class="nav navbar-nav navbar-right">
            <li><a href="<?php echo $url ?>">Beranda</a></li>
            <li><a href="<?php echo $url ?>menu.php">Katalog</a></li> 
   ...
   <?php if('http://'.$_SERVER['HTTP_HOST'].$_SERVER['PHP_SELF'] == $url.'index.php'){ ?>
    ...
    <header id="myCarousel" class="carousel slide">
        ...
        <!-- Wrapper for Slides -->
          <div class="carousel-inner" style="height: 240px; margin-top:-4px">
            <div class="item active">
                <!-- Set the first background image using inline CSS below. -->
                <div class="fill" style=" background-size:960px; background-image:url('<?php $url ?>assets/img/h1.jpg');">
            ...
            <div class="item">
                ...
                <div class="fill" style="background-size:960px; background-image:url('<?php $url ?>assets/img/h2.jpg');"></div>
                <div class="carousel-caption">
                    <!-- <h2>Caption 2</h2> -->
                </div>
            </div> 
   ...
   <?php } ?>
	...
	<div class="row">
		<div class="col-md-3">
			<div style="background:rgb(100, 9, 9); width:100%; height:auto; padding-top:3px;padding-bottom:3px; padding-left:10px;">
			<h4 style="color: white;">Kategori Barang</h4>
			</div>
			<ul class="kategori" style="margin-top: 20px;">
				<?php 
					$kategori = mysql_query("SELECT * FROM kategori_produk"); 
					while($data = mysql_fetch_array($kategori)){
				?>
					<li style="margin-top:-20px"><a href="<?php echo $url; ?>menu.php?kategori=<?php echo $data['id'] ?>"><?php echo $data['nama']; ?> (
					<?php 
			...
			<div style=" width:100%; height:auto; background:#fff; padding-top:3px;padding-bottom:3px; padding-left:10px; 	margin-bottom:15px; margin-top:-10px; border: 1px dashed #000;">
			...
			<div class="row col-md-12" style="margin-bottom: 20px;">
				<hr>
				<img src="<?php echo $url.'assets/img/bar1.png'; ?>" width="100%"><br><br>
				<img src="<?php echo $url.'assets/img/bar2.png'; ?>" width="100%">
			</div>
		</div>